...
### 索引是个什么样的数据结构
    ...
    而我们经常使用的InnoDB存储引擎的默认索引实现为B+树索引.
...
[索引设计规范](https://my-skills-book.readthedocs.io/en/latest/databases/Mysql/MySQL规范.html#id16)
...
锁的粒度取决于具体的存储引擎,InnoDB实现了行级锁,表级锁,页级锁.
